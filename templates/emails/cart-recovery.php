    ...
    <tr>
        <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
                <tr>
                    <td style="padding:32px;background:linear-gradient(135deg,{{primary_color}} 0%,{{accent_color}} 100%);text-align:center;">
                        {{logo_html}}
                ...
                <tr>
                    <td style="padding:32px;">
                        ...
                        <p style="margin:0 0 24px;text-align:center;">
                            <a href="{{recovery_link}}" style="display:inline-block;padding:14px 32px;background:linear-gradient(135deg,{{primary_color}} 0%,{{accent_color}} 100%);color:#fff;text-decoration:none;font-weight:600;font-size:16px;border-radius:8px;">
                        ...
                        <p style="margin:0;color:#6b7280;font-size:12px;">
                            ...
                            <br>
                            <a href="{{recovery_link}}" style="color:{{primary_color}};word-break:break-all;">{{recovery_link}}</a>
                        </p>
                    </td>
                </tr>
                <tr>
